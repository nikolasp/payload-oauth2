import type { BasePayload, PayloadRequest, TextField, TypedUser } from "payload";
export interface PluginOptions {
     ...
     */
    successRedirect(req: PayloadRequest, accessToken: string): string | Promise<string>;
    /**
     ...
     * @default undefined
     */
    resolveUserIdentity?: (jwtUser: Record<string, unknown>, payload: BasePayload) => Promise<({
        _strategy?: string;
        collection?: string;
    } & TypedUser) | null>;
}
